# On line 62 I add logic to add a new student Scott who is not connected
#to any major or department. I put this in to show where I would put items
# I actual just used insert into student values('7','Scott','Wilson','1989-07-15') 
# after the database was created to create the student
import sqlite3
...
insert_sql = """
	...
	insert into student (id, first_name, last_name, dob) values ('7','Scott','Wilson','1989-07-15');
